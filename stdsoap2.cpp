...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.7.9a 2006-19-24 12:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.7.9 2006-11-19 12:00:00 GMT")
#endif
...
#pragma warning(disable: 4267) /* Disable Visual Studio Express 2008 compiler warning */
#pragma warning(disable: 4244) /* Disable Visual Studio Express 2008 compiler warning */
#pragma warning(disable: 4311) /* Disable Visual Studio Express 2008 compiler warning */
...
#else
      nwritten = _write((SOAP_SOCKET)soap->sendfd, s, n);
#endif
#endif
#endif
      if (nwritten <= 0)
...
#endif
  r = _read((SOAP_SOCKET)soap->recvfd, s, n);
  if (r >= 0)
    return (size_t)r;
...
#pragma warning(default: 4267) /* Restore default */
#pragma warning(default: 4244) /* Restore default */
#pragma warning(default: 4311) /* Restore default */